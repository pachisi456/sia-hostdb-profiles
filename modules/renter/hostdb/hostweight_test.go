...
func calculateWeightFromUInt64Price(price uint64) (weight types.Currency, blacklist bool) {
	hdb := bareHostDB()
	hdb.blockHeight = 0
	...
	return hdb.calculateHostWeight(entry, "default")
}
...
func TestHostWeightDistinctPrices(t *testing.T) {
	...
	weight1, _ := calculateWeightFromUInt64Price(300)
	weight2, _ := calculateWeightFromUInt64Price(301)
...
func TestHostWeightIdenticalPrices(t *testing.T) {
	...
	weight1, _ := calculateWeightFromUInt64Price(42)
	weight2, _ := calculateWeightFromUInt64Price(42)
	if weight1.Cmp(weight2) != 0 {
...
func TestHostWeightWithOnePricedZero(t *testing.T) {
	...
	weight1, _ := calculateWeightFromUInt64Price(5)
	weight2, _ := calculateWeightFromUInt64Price(0)
	if weight1.Cmp(weight2) >= 0 {
...
func TestHostWeightWithBothPricesZero(t *testing.T) {
	...
	weight1, _ := calculateWeightFromUInt64Price(0)
	weight2, _ := calculateWeightFromUInt64Price(0)
	if weight1.Cmp(weight2) != 0 {
...
func TestHostWeightCollateralDifferences(t *testing.T) {
	...
	w1, _ := hdb.calculateHostWeight(entry, "default")
	w2, _ := hdb.calculateHostWeight(entry2, "default")
	if w1.Cmp(w2) < 0 {
